...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Cysharp_Threading_Tasks_AddressablesAsyncExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Collections.Generic.IList<UnityEngine.Material>)};
            if (genericMethods.TryGetValue("GetAwaiter", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(Cysharp.Threading.Tasks.UniTask<System.Collections.Generic.IList<UnityEngine.Material>>.Awaiter), typeof(UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle<System.Collections.Generic.IList<UnityEngine.Material>>)))
                    {
            ...
            if (genericMethods.TryGetValue("GetAwaiter", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(Cysharp.Threading.Tasks.UniTask<UnityEngine.GameObject>.Awaiter), typeof(UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle<UnityEngine.GameObject>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle<System.Collections.Generic.IList<UnityEngine.Material>> @handle = (UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle<System.Collections.Generic.IList<UnityEngine.Material>>)typeof(UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle<System.Collections.Generic.IList<UnityEngine.Material>>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = Cysharp.Threading.Tasks.AddressablesAsyncExtensions.GetAwaiter<System.Collections.Generic.IList<UnityEngine.Material>>(@handle);
        ...
        static StackObject* GetAwaiter_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Cysharp.Threading.Tasks.AddressablesAsyncExtensions.GetAwaiter<UnityEngine.GameObject>(@handle);
